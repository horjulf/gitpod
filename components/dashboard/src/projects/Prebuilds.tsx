...
import { PrebuildInfo, PrebuiltWorkspaceState, ProjectInfo } from "@gitpod/gitpod-protocol";
    ...
    return <>
        ...
        <div className="lg:px-28 px-10">
            <div className="flex mt-8">
                ...
                <button onClick={() => { /* TODO */ }} className="ml-2">Trigger Prebuild</button>
            </div>
            <ItemsList className="mt-2">
                ...
                {filteredPrebuilds.map(p => <Item className="grid grid-cols-3">
                    ...
                    <ItemField className="flex items-center">
                        <div>
                            <div className="text-base text-gray-500 dark:text-gray-50 font-medium mb-1">{p.changeTitle}</div>
